...
namespace AgendaApi.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public ActionResult<string> Autenticar(AuthDto authenticationRequestBody) //Enviamos como parámetro la clase que creamos arriba
        {
            ...
            var claimsForToken = new List<Claim>
            {
                ...
                new Claim("given_name", user.FirstName), //Lo mismo para given_name y family_name, son las convenciones para nombre y apellido. Ustedes pueden usar lo que quieran, pero si alguien que no conoce la app
                new Claim("family_name", user.LastName) //quiere usar la API por lo general lo que espera es que se estén usando estas keys.
            };
